    ...
    const htmlText = `
      ...
      <div class="content-info">
        ...
        <div class="article-info">
          ...
          <span class="article-date">${COMMON.formatDate('YYYY.MM.DD',
      detail.date)}</span>
        </div>
      </div>
      ...
      <div class="content-text">${filterXSS(detail.content)}</div>
    `
      ...
      htmlText += `
        <li class="comment-item">
          ...
          <div class="comment-item-content">
            ...
            <p class="comment-item-text">${B.htmlEncode(item.comment)}</p>
          </div>
          <p class="comment-item-date">${COMMON.formatDate('YYYY.MM.DD',
        item.date)}</p>
        </li>
      `
    })
